...
var Lignedefrais = {
    ...
    createLignedefrais: function (data, callback) {
        ...
        return db.query('INSERT INTO t_ligne_de_frais(id_ndf, id_mission, libelle_ldf, montant_ldf, \
            ...
            UPDATE t_ligne_de_frais_avance SET id_statut = 6 WHERE id_ndf = ? AND id_statut > 5 ; \
    ...
    updateLignedefrais: function (data, callback) {
        ...
        UPDATE t_ligne_de_frais_avance SET id_statut = 6 WHERE id_ndf = ' + data.id_ndf + ' AND id_statut = 7 ; \
